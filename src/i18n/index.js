...
それ以来<em>${count}</em>日経過しました`
        ...
        scene3: {
            ...
            p2: (count, i1, i2, i3) => `${count ? `初めての友人に出会った日は特別な日であり、本日は第<em>${i1}</em>日の記念日です
...
まだ友達とともに戦ったことがありません。`}
${ i3 ? `悲しいことに、<em>${i3.substr(0, 4)+'年'+i3.substr(4, 2) + '月' + i3.substr(6, 2) + '日'}</em>に荘園から離れ、久しく連絡が取れていない友達もいます
